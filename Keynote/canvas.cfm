...
<head>
<meta charset="utf-8">
<title>Sierpinski Triangle Canvas Demo</title>
<script>
...
<cfheader name="Content-Disposition" value="inline;filename=canvas.pdf">
<cfcontent type="application/pdf" file="C:\cf23\cfusion\wwwroot\PDFEngineDemo\canvas.pdf">
